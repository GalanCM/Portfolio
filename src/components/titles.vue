    ...
    <div class="titles-wrapper" v-show=" show "> <!-- titles only show on first site visit -->
      ...
      <div class="titles" :style="{ top: 'calc(50vh + '+center_gap+'px)' }"> <!-- wrapper for the text proper -->
        ...
        <div :class="{text: true, on: show_text}" :style="{ transform: 'scale(' + scale_factor + ')', position: 'absolute', right: 0 }">
          <object class="developer" :data=" require( '../assets/ux engineer.svg' )" type="image/svg+xml" style="position: absolute; right: -10px;"></object>
          <object class="and" :data=" require( '../assets/and.svg' )" type="image/svg+xml" style="position: absolute; right:0;"></object>
          <object class="designer" :data=" require( '../assets/game developer.svg' )" type="image/svg+xml" style="position: absolute; right: -10px;"></object>
        </div>
      </div>
...
export default class Titles extends Vue {
  ...
  @Prop()
  show!: boolean; // whether or not the titles should be displayed
