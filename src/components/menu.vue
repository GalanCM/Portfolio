<template>
  <transition name="fade">
    <section v-show="$route.path === '/'" class="menu-wrapper">
      ...
      <MenuItem color="#ff825c" url="portfolio" style="grid-row: 4">
